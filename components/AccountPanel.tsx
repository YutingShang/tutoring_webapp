...
const [showAccountPanel, setShowAccountPanel] = useState(false)
    ...
    return(<>
    <div className="z-50 account mt-6 absolute top-0 right-6 md:top-6 md:right-6 md:mt-0 text-right">
                    
                <OutsideClickHandler onOutsideClick={()=>setShowAccountPanel(false)}> 
                    {(showAccountName || showAccountPanel )&& <p className="inline-block px-3 text-slate-600 leading-relaxed text-[14px]">{props.session.user.name}</p>}
                    ...
                    <div className="p-5 pb-6  mt-2 rounded-lg bg-gray-100 drop-shadow-md">
